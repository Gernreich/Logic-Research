...
#  f = open("R9FALSE__l2b", "a")
#  g = open("R9FALSE__syn0b", "a")
#  h = open("R9FALSE__syn1b", "a")   
#  print(l2.T, file=f)
#  print(syn0, file=g)
#  print(syn1.T, file=h)
#  f.close() 
...
#  h.close()
 if (l2[0]<=o) and (l2[1]<=o) and (l2[2]<=o) and (l2[3]>=n):
  f = open("R9AND__l2b", "a")
  g = open("R9AND__syn0b", "a")
  h = open("R9AND__syn1b", "a")   
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
 ...
 if (l2[0]<=o) and (l2[1]<=o) and (l2[2]>=n) and (l2[3]<o):
  f = open("R9PMINUSQ__l2b", "a")
  g = open("R9PMINUSQ__syn0b", "a")
  h = open("R9PMINUSQ__syn1b", "a")   
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
 ...
 if (l2[0]<=o) and (l2[1]>=n) and (l2[2]<=o) and (l2[3]<=o):
  f = open("R9QminusP__l2b", "a")
  g = open("R9QminusP__syn0b", "a")
  h = open("R9QminusP__syn1b", "a")
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
 ...
 if (l2[0]<=o) and (l2[1]>=n) and (l2[2]>=n) and (l2[3]>=n):
  f = open("R9OR__l2b", "a")
  g = open("R9OR__syn0b", "a")
  h = open("R9OR__syn1b", "a")   
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
 ...
 if (l2[0]>=n) and (l2[1]<=o) and (l2[2]>=n) and (l2[3]<=o):
  f = open("R9NOTQ__l2b", "a")
  g = open("R9NOTQ__syn0b", "a")
  h = open("R9NOTQ__syn1b", "a")   
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
 ...
 if (l2[0]>=n) and (l2[1]<=o) and (l2[2]>=n) and (l2[3]>=n):
  f = open("R9IMPLICATION__l2b", "a")
  g = open("R9IMPLICATION__syn0b", "a")
  h = open("R9IMPLICATION__syn1b", "a")   
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
 ...
 if (l2[0]>=n) and (l2[1]>=n) and (l2[2]<=o) and (l2[3]<=o):
  f = open("R9NOTP__l2b", "a")
  g = open("R9NOTP__syn0b", "a")
  h = open("R9NOTP__syn1b", "a")   
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
 ...
 if (l2[0]>=n) and (l2[1]>=n) and (l2[2]<=o) and (l2[3]>=n):
  f = open("R9REVIMPLICATION__l2b", "a")
  g = open("R9REVIMPLICATION__syn0b", "a")
  h = open("R9REVIMPLICATION__syn1b", "a")
  print(l2.T, file=f)
  print(syn0, file=g)
  print(syn1.T, file=h)
  f.close() 
...
#  f = open("R9TRUE__l2b", "a")
#  g = open("R9TRUE__syn0b", "a")
#  h = open("R9TRUE__syn1b", "a")   
#  print(l2.T, file=f)
#  print(syn0, file=g)
#  print(syn1.T, file=h)
#  f.close() 
